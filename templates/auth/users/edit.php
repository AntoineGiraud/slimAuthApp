...
<h1 class="page-header clearfix">
    ...
    <div class="pull-right">
        ...
        <a href="<?= $RouteHelper->getPathFor('auth/users/list') ?>" class="btn btn-primary">Liste</a>
    </div>
</h1>
            ...
            <div>
                ...
                <?php if (!empty($RouteHelper->conf['Auth']['canEditUserId'])) { ?>
                    <div class="form-group <?= $ErrorsCtrl->hasError('newId')?'has-error':'' ?>">
                        ...
                        <div class="col-sm-4"><?= $ErrorsCtrl->showError('newId') ?></div>
                    </div>
                <?php } ?>
                <div class="form-group <?= $ErrorsCtrl->hasError('email')?'has-error':'' ?>">
                    ...
                    <div class="col-sm-4"><span class="help-block"><em>Identifiant</em> <?= $ErrorsCtrl->showError('email', true) ?></span></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="roles[]" class="form-control" id="selectrole_id" multiple size="6">
        ...
        <fieldset class="password clear">
            ...
            <div class="pass">
                <div class="form-group <?= $ErrorsCtrl->hasError('password')?'has-error':'' ?>">
                    ...
                    <div class="col-sm-4"><?= $ErrorsCtrl->showError('password') ?></div>
                </div>
                <div class="form-group <?= $ErrorsCtrl->hasError('password')?'has-error':'' ?>">
